...
using Mpeg2VideoPesPacketParser;
...
namespace CustomizedParser
{
    public class ParserPlugin : IParserPlugin
    {
        ...
        {
            return "MPEG2 Video PES Packet Parser";
        }
        ...
        {
            return "Plugin to parse MPEG2 video PES packet.";
        }
                ...
                else
                {
                        ...
                        == GetStreamTypeFromStreamId(streamId))*/
                    {
                        ...
                        if (result.Fine)
                        {
                            ...
                            if (result.Fine)
                            {
                                Mpeg2VideoParser parser = new Mpeg2VideoParser();
